...
sessions = ["Mouse12-120806", "Mouse12-120807", "Mouse12-120809", "Mouse12-120810", "Mouse17-130125",
...
for session in sessions:
    ...
    parser.add_argument("--ckpt_path", default="../saved_models/RVAE/spike_epoch40_"+session+".ckpt", type=str)
