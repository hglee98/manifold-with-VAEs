...
sessions = ["Mouse12-120809", "Mouse12-120810", "Mouse17-130125",
...
for session in sessions:
    ...
    parser.add_argument("--device", default="cuda:2", type=str, help="cuda | cpu")
    ...
    # parser.add_argument("--ckpt_path", default="../saved_models/RVAE/spike_epoch40_batch_16"+session+"_sub.ckpt", type=str)
