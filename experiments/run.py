...
for session in sessions:
    ...
    parser.add_argument("--warmup_learning_rate", default=1e-3, type=float, help="maximum p_mu learning rate")
    ...
    parser.add_argument("--ckpt_path", default="../saved_models/RVAE/spike_epoch40_batch_256"+session+".ckpt", type=str)
