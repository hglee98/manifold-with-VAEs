...
parser.add_argument("--mu_epochs", default=20, type=int, help="number of training epochs (decoder mu)")
parser.add_argument("--sigma_epochs", default=20, type=int, help="number of training epochs (decoder sigma)")
